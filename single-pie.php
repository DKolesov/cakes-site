<?php
/*
Single Post Template: Шаблон записи {Выпечка}
*/
?>
<?php
					...
					<div class="col-md-6">
						<div class="row">
							<div class="single-head">
								<?php the_field('my_pie_name', $post_id); ?>
							</div>
							<div class="single-descript">
								<?php the_field('my_pie_consist', $post_id); ?>
							</div>
							<div class="single-price">
								Стоимость: <?php the_field('my_pie_price', $post_id); ?> руб./шт.
							</div>
