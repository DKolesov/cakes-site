	<?php /*Template Name: catalog-pie-page*/ ?>
	...
	<div class="catalog-nav">
		<div class="container">
			...
			<div class="col-md-2 col-sm-4 col-xs-12">
				...
				<div class="catalog-nav-img">
					<img src="<?php bloginfo('template_directory'); ?>/img/pie-icon-red.png" alt="">
				</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="head-text">Выпечка</div>

			<?php
				$wp_query = new WP_Query( array( 'cat' => '18' ) );
