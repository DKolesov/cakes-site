<?php
/*
Single Post Template: Шаблон записи {Торты}
*/
?>
<?php
					...
					<div class="col-md-6">
						<div class="row">
							<div class="single-head">
								<?php the_field('my_cake_name', $post_id); ?>
							</div>
							<div class="single-descript">
								<?php the_field('my_cake_consist', $post_id); ?>
							</div>
							<div class="single-price">
								Стоимость: <?php the_field('my_cake_price', $post_id); ?> руб./кг.
							</div>
