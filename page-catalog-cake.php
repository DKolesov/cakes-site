	<?php /*Template Name: catalog-cake-page*/ ?>
		...
		<div class="container">
			...
			<div class="col-md-2 col-sm-4 col-xs-12">
				...
				<div class="catalog-nav-img">
					<img src="<?php bloginfo('template_directory'); ?>/img/tort-icon-red.png" alt="">
				</div>
			...
			<div class="col-md-2 col-sm-4 col-xs-12">
				...
				<div class="catalog-nav-img">
					<img src="<?php bloginfo('template_directory'); ?>/img/desert-icon-red-unactive.png" alt="">
				</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="head-text">Торты</div>

			<?php
				$wp_query = new WP_Query( array( 'cat' => '19' ) );
			...
			<div class="product col-md-3 col-sm-6">
				<div class="product-wrapper">
					<?php 
						$my_image = get_field('my_cake_photo', $post_id); 
						if( !empty($my_image) ): 
					?>
					...
					<div class="product-text-wrapper">
						<div class="product-descript">
							<b><?php the_field('my_cake_name', $post_id); ?></b>
							<p>Стоимость: <?php the_field('my_cake_price', $post_id); ?> руб./кг.</p>
						</div>
